  ...
  return (
    <SafeAreaView style={styles.SafeAreaView}>
      <Stack.Navigator screenOptions={{ headerShown: false }} >
        ...
        <Stack.Screen name="Tempfile" component={Tempfile} options={{
          headerShown: true, title: 'Order Summary', headerTitleStyle: {
            fontSize: 18, fontWeight: 'bold'
          },
        }} />
        <Stack.Screen name="Payment" component={Payment} options={{
          headerShown: true, title: 'Payment Options', headerTitleStyle: {
            fontSize: 18, fontWeight: 'bold'
          },
        }} />
